...
```
##Interesting use of read_tsv, any specific reason?
...
```
##Nicely done, informative description of the data.  I will use this format in the future!!
...
```
##I came across this issue too with the header causing problems, if only there was a standardized way to transform data without having to worry about stuff like that.
...
```
##Nicely done here, I was unable to move the files completely but I trust that it works fine given the use of the correct relative path etc.
...
```
##Looks the same as above, which worked just fine so I trust this too.
...
```
##Nicely done again, other than the moving of the files which is not terribly important.  So far so good and quite informative, good work up to this point.
...
```
##Nice plot, direct and to the point, which is explaining the differences in SNP counts across chromosomes.
...
```
##Interesting plot, I found something similar but with flipped axis, it reminded me somewhat of gel electrophoresis and similar techniques.
...
Missing_data_plot1
```
##Great plot!! I again did something similar and returned a similar result!
...
##Again nice plot, I again had a similar result! I ran a scatterplot visualization which was quite interesting if you want to check it out!
...
group_plot
```
##Nice visualization, I like it.  Overally very well done!!  Informative and effecient work, I learned a lot through your work and it was a pleasure to review!  I'll keep note of some of your techniques for future projects.  10/10.
