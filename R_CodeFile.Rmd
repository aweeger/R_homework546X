...
file.move("../R_Assignment/Maize_Chr1.csv", "../R_Assignment/Maize_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Maize_Chr2.csv", "../R_Assignment/Maize_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Maize_Chr3.csv", "../R_Assignment/Maize_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Maize_Chr4.csv", "../R_Assignment/Maize_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Maize_Chr5.csv", "../R_Assignment/Maize_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Maize_Chr6.csv", "../R_Assignment/Maize_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Maize_Chr7.csv", "../R_Assignment/Maize_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Maize_Chr8.csv", "../R_Assignment/Maize_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Maize_Chr9.csv", "../R_Assignment/Maize_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Maize_Chr10.csv", "../R_Assignment/Maize_chromosome_forward", overwrite = T)
```
...
file.move("../R_Assignment/Teosinte_Chr1.csv", "../R_Assignment/Teosinte_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Teosinte_Chr2.csv", "../R_Assignment/Teosinte_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Teosinte_Chr3.csv", "../R_Assignment/Teosinte_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Teosinte_Chr4.csv", "../R_Assignment/Teosinte_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Teosinte_Chr5.csv", "../R_Assignment/Teosinte_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Teosinte_Chr6.csv", "../R_Assignment/Teosinte_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Teosinte_Chr7.csv", "../R_Assignment/Teosinte_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Teosinte_Chr8.csv", "../R_Assignment/Teosinte_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Teosinte_Chr9.csv", "../R_Assignment/Teosinte_chromosome_forward", overwrite = T)
file.move("../R_Assignment/Teosinte_Chr10.csv", "../R_Assignment/Teosinte_chromosome_forward", overwrite = T)
```
...
file.move("../R_Assignment/rev_Maize_Chr1.csv", "../R_Assignment/Maize_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Maize_Chr2.csv", "../R_Assignment/Maize_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Maize_Chr3.csv", "../R_Assignment/Maize_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Maize_Chr4.csv", "../R_Assignment/Maize_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Maize_Chr5.csv", "../R_Assignment/Maize_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Maize_Chr6.csv", "../R_Assignment/Maize_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Maize_Chr7.csv", "../R_Assignment/Maize_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Maize_Chr8.csv", "../R_Assignment/Maize_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Maize_Chr9.csv", "../R_Assignment/Maize_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Maize_Chr10.csv", "../R_Assignment/Maize_chromosome_reverse", overwrite = T)
```
...
file.move("../R_Assignment/rev_Teosinte_Chr1.csv", "../R_Assignment/Teosinte_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Teosinte_Chr2.csv", "../R_Assignment/Teosinte_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Teosinte_Chr3.csv", "../R_Assignment/Teosinte_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Teosinte_Chr4.csv", "../R_Assignment/Teosinte_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Teosinte_Chr5.csv", "../R_Assignment/Teosinte_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Teosinte_Chr6.csv", "../R_Assignment/Teosinte_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Teosinte_Chr7.csv", "../R_Assignment/Teosinte_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Teosinte_Chr8.csv", "../R_Assignment/Teosinte_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Teosinte_Chr9.csv", "../R_Assignment/Teosinte_chromosome_reverse", overwrite = T)
file.move("../R_Assignment/rev_Teosinte_Chr10.csv", "../R_Assignment/Teosinte_chromosome_reverse", overwrite = T)
```
